...
namespace MyVet.Web.Controllers.API
{
    ...
    public class OwnersController : ControllerBase
    {
        ...
        //los métodos get los enviamos por los post por seguridad
        //los get envian un Body que es visible los post por el Route son encriptados
        //El metodo fisico es GetOwner pero al rutearlo se cambia por GetOwnerByEmail
