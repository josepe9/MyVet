...
namespace MyVet.Web.Controllers
{
    ...
    public class OwnersController : Controller
    {
        ...
        public async Task<IActionResult> Create(AddUserViewModel model)
        {
            ...
            {
                //Se debe crear el usuario primero en User
                var user = new User
                {
                ...
                //lo adicionamos en user
                var response = await _userHelper.AddUserAsync(user, model.Password);
                if (response.Succeeded)
                {
                    //obtenemos el user recien grabado para asignarle el rol
                ...
                //Mandamos el error por no poder guardar usuario
        ...
        public async Task<IActionResult> Delete(int? id)
        {
            ...
            //Primero se borra el usuario que está amarrado al Owner o dueño de las mascotas
        ...
        //Metodo que trabaja con el JQuery de la vista DetailsPet
        ...
        //Metodo que trabaja con el JQuery de la vista Details
